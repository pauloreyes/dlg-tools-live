	...
	return (
		<div className='bg-white p-6 rounded-lg shadow-md w-[80%] mx-auto'>
			<div className='flex gap-6'>
				<div
					className={
						history.length > 0 ? "w-1/2" : "w-full flex justify-center items-center"
					}
				>
											...
											<div className='flex items-center gap-2'>
												...
												>
													<svg
														...
														className='size-6'
													>
														<path d='M3.375 3C2.339 3 1.5 3.84 1.5 4.875v.75c0 1.036.84 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75C22.5 3.839 21.66 3 20.625 3H3.375Z' />
														<path
															fill-rule='evenodd'
